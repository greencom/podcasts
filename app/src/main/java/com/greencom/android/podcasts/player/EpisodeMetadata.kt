...
object EpisodeMetadata {
    ...
    /** Media metadata string key for the episode ID. */
    const val ID = MediaMetadata.METADATA_KEY_MEDIA_ID

    /** Media metadata string key for the episode title. */
    const val TITLE = MediaMetadata.METADATA_KEY_TITLE

    /** Media metadata string key for the episode's parent podcast title. */
    const val PODCAST_TITLE = MediaMetadata.METADATA_KEY_ARTIST

    /** Media metadata string key for the episode's parent podcast ID. */
    const val PODCAST_ID = MediaMetadata.METADATA_KEY_AUTHOR

    /** Media metadata string key for the episode image URI. */
    const val IMAGE = MediaMetadata.METADATA_KEY_ART_URI

    /** Media metadata string key for the episode duration. */
